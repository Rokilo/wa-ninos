...
const BotonAventuras = () => {

    return (
        <div className="justify-center flex">
            <button className="bg-green-500 hover:bg-green-700 text-black font-bold py-6 px-8 rounded-full mt-10 align-center" onClick={()=>document.getElementById('my_modal_1').showModal()}>Añadir Aventura</button>
            <dialog id="my_modal_1" className="modal">
              <div className="modal-box m-10">
                <h3 className="font-bold text-lg">Título:</h3>
                <input id="titulo" placeholder="Nombre Aventura" name="titulo" type="text"  required class="my-4 block w-full rounded-md border-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-3"/>
